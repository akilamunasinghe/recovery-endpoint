...
%>
    ...
    <div class="container-fluid body-wrapper">
        ...
        <div class="background-blue row">
            <!-- content -->
            <div class="background-blue col-xs-12 col-sm-10 col-md-8 col-lg-6 col-centered wr-login">
                <form action="signup.do" method="post" id="register">

                    <div class="boarder-all ">
                        <h2
                                class="section__title_joule wr-title uppercase padding-double white margin-none">
